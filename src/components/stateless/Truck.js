...
function Truck({truckName, orders, fromTop, timeLineWidth, firstCurrentTimePoint}) {
    ...
    return (         
        <div className="truck" style={{top: fromTop}}>
            ...
            <svg class="truckIcon" width="6rem" height="inherit" viewBox="0 0 400 240" fill="none" xmlns="http://www.w3.org/2000/svg">
            <rect x="19" y="64" width="287" height="92" fill="var(--primaryColor)"/>
            <path fill-rule="evenodd" clip-rule="evenodd" d="M238 166H19V175.556L39.6656 185H238V166Z" fill="var(--primaryColor)"/>
            ...
            <circle cx="345" cy="191" r="23" fill="var(--primaryColor)" stroke="white" stroke-width="4"/>
            <circle cx="69" cy="191" r="23" fill="var(--primaryColor)" stroke="white" stroke-width="4"/>
            <circle cx="134" cy="191" r="23" fill="var(--primaryColor)" stroke="white" stroke-width="4"/>
            <circle cx="280" cy="191" r="23" fill="var(--primaryColor)" stroke="white" stroke-width="4"/>
            </svg>
               <span class="tName">{truckName}</span></div>
